...
```shell
. { iwr -useb https://raw.githubusercontent.com/HewlettPackard/terraform-provider-hpegl/Windows-Install/tools/install-hpegl-provider-windows.ps1 } -VERSION v0.0.1 | iex;
```
